...
comments = Comment.create([
    { approved: true, text: "Ein Kommentar.", post_id: 1, user_id: 1 },
    { approved: true, text: "Noch einer.", post_id: 1, user_id: 1 },
    { approved: true, text: "Und noch einer.", post_id: 1, user_id: 1 },
    { approved: true, text: "Der hier gehört zum 2. Post.", post_id: 2, user_id: 1 }
])
